...
class ThreadViewSet(viewsets.ModelViewSet):
    ...
    @method_decorator(user_passes_test(lambda u: u.user_type == USERTYPE_ADMIN))
    ...
    def list(self, request, *args, **kwargs):
        queryset = Thread.objects.annotate(num_messages=Count('messages')).all()
        serializer = ThreadListSerializer(queryset, 
